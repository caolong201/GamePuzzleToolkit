...
using UnityEngine.EventSystems;
    ...
    public class GameUI : Singleton<GameUI>
    {
        ...
        //public void ShowPopUpNotification(TypeNotification typeNotification)
        //{
        //    var popUp = ObjectPool.Get(popupNotification, transform);
        //    popUp.transform.SetSiblingIndex(transform.childCount);
        //    //popUp.transform.position = Vector3.zero;
        //    popUp.GetComponent<PopupNotice>().ShowNotification(typeNotification);
        //}
    }
